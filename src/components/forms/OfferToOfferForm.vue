  ...
  methods: {
    ...
    async init() {
      ...
      if (this.currentMode !== "add") {
        ...
        //this.formModel.offerType = this.$route.params.offerType;
      ...
      try {
        const response = this.$api
          ...
          .then((_response) => {
            ...
            this.addBulkOfferItem();
            this.$q.notify({
              progress: true,
              type: "info",
              color: "info",
              message: "Teklif Oluşturuldu" /*this.$t("success")*/,
    ...
    async addBulkOfferItem() {
      await this.formModel.offerItems.map((oi) => {
        oi.offerId = this.formModel.id;
        const _response = this.$api
          .post("postOfferItem", JSON.stringify(oi))
          .then((response) => {
