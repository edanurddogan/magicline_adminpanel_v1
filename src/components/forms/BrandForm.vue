  ...
  methods: {
    async init() {
      try {
        ...
        this.$logger.log("brands", response?.data);
    ...
    async addFormModel() {
      const _response = this.$api
        .post("brands", JSON.stringify(this.newModel))
        .then((response) => {
    ...
    async editFormModel() {
      const response = this.$api
        .put("brands", JSON.stringify(this.newModel))
        .then((_response) => {
    ...
    async onDelete(row) {
      try {
        ...
        const response = await this.$api.delete("brands/" + row.id);
        this.getList();
