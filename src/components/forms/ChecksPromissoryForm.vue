    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <q-card-section class="bg-primary text-white">
          <div>{{ $t("finance.checksPromissory.checksPromissory") }}</div>
        </q-card-section>
        <q-separator />
        <q-card-section>
          <q-list class="row">
            <q-item class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <q-item-section>
                <q-input
                  ...
                  :label="$t('finance.checksPromissory.documentNo')"
            ...
            <q-item class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <q-item-section>
                <q-input
                  :disable="mode === 'details'"
                  :label="$t('finance.checksPromissory.amount')"
            ...
            <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <q-item-section>
                <q-input
                  :disable="mode === 'details'"
                  :label="$t('finance.checksPromissory.termDay')"
                  v-model="formModel.termDay"
                />
              </q-item-section>
            </q-item>
            ...
            <q-item class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <q-item-section>
                <q-input
                  v-model="formModel.termDate"
                  type="date"
                  :disable="mode === 'details'"
                  :label="$t('finance.checksPromissory.termDate')"
                  @change="dateChange"
                />
              </q-item-section>
            </q-item>
                ...
                <q-card class="q-pa-md col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <q-card-actions>
                    <q-btn-toggle
                      ...
                      :options="[
                        { value: 'Çek', slot: 'one' },
                        { value: 'Senet', slot: 'two' },
                      ]"
                    >
                      <template v-slot:one>
                        <div class="row items-center no-wrap">
                          <q-icon color="grey-1" left name="arrow_downward" />
                          <div class="text-center">Çek</div>
                        </div>
                      </template>

                      <template v-slot:two>
                        <div class="row items-center no-wrap">
                          <div class="text-center">Senet</div>
    ...
    columns() {
      return [
        ...
        },
        {
          ...
          align: "center",
          field: (row) =>
            row.price + " " + this.formModel.order.currency.symbol,
          sortable: true,
        },
        {
          name: "discount",
        ...
        },
        {
          ...
          align: "center",
          field: (row) =>
            row.unitAmount + " " + this.formModel.order.currency.symbol,
          sortable: true,
        },
        {
          name: "vatrate",
        ...
        },
        {
          ...
          align: "center",
          field: (row) =>
            row.unitsumamount + " " + this.formModel.order.currency.symbol,
          sortable: true,
        },
        {
          name: "status",
