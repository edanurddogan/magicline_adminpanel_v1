...
export default defineComponent({
  name: "TechnicalServiceTypesForm",
  components: {},
  computed: {
    columns() {
      return [
  ...
  methods: {
    ...
    async addFormModel() {
      ...
      const _response = this.$api
        .post("technicalServiceTypes", this.formModel)
        .then((response) => {
    ...
    async editFormModel() {
      ...
      const response = this.$api
        .put("technicalServiceTypes", this.formModel)
        .then((_response) => {
    ...
    async getList() {
      const response = this.$api.get("technicalServiceTypes").then((data) => {
