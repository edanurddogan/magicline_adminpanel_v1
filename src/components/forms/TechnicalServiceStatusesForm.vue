...
export default defineComponent({
  name: "TechnicalServiceStatusesForm",
  components: {},
  computed: {
    columns() {
      return [
  ...
  methods: {
    ...
    async addFormModel() {
      ...
      const _response = this.$api
        .post("technicalServiceStatuses", this.formModel)
        .then((response) => {
    ...
    async editFormModel() {
      ...
      const response = this.$api
        .put("technicalServiceStatuses", this.formModel)
        .then((_response) => {
    ...
    async onDelete(row) {
      try {
        ...
        row.isActive = false;
        const response = await this.$api.put("technicalServiceStatuses", row);
        this.getList();
