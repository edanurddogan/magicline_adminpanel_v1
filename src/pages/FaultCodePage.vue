        ...
        <div class="row col-12">
          ...
          >
            <q-tooltip transition-show="flip-right" transition-hide="flip-left">
              {{ $t("technicalService.faultCodeAdd") }}
            </q-tooltip>
          </q-btn>
          <q-btn
            flat
    ...
    <q-dialog v-model="deleteConfirm" persistent>
      <q-card class="q-pa-md">
        ...
        <q-card-section class="items-center">
          ...
          <h5>{{ $t("technicalService.faultCodeDelete") }}</h5>
          <p>{{ $t("technicalService.faultCode") }} : {{ currentRow.code }}</p>
          <p>{{ $t("technicalService.detail") }} : {{ currentRow.detail }}</p>
        </q-card-section>
...
import FaultCodeForm from "src/components/forms/FaultCodeForm.vue";
  ...
  computed: {
    columns() {
      return [
        {
          name: "code",
          label: this.$t("technicalService.faultCode"),
          align: "left",
          field: (row) => row.code,
          sortable: true,
        },
        {
          name: "detail",
          required: true,
          label: this.$t("technicalService.detail"),
          align: "left",
        ...
        {
          name: "priority",
          label: this.$t("technicalService.priority"),
  ...
  methods: {
    ...
    async getList() {
      try {
        ...
        this.$logger.log("Fault Codes =>", response.data);
        this.loading = false;
      } catch (error) {
