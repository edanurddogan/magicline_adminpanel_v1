  ...
  <div class="q-pa-md">
    ...
    >
      ...
      <template v-slot:item="props">
        <div
          class="q-pa-xs col-xs-12 col-sm-12 col-md-6 col-lg-4 grid-style-transition"
...
import OfficeForm from "src/components/forms/OfficeForm.vue";
...
export default defineComponent({
  ...
  async mounted() {
    this.init();
    const response = await this.$api.get("offices");
