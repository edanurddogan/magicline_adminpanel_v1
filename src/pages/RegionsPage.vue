    ...
    <q-dialog v-model="deleteConfirm" persistent>
      <q-card class="q-pa-md">
        ...
        <q-card-section class="items-center">
          ...
          <h5>{{ $t("definitions.regionDelete") }}</h5>
          <p>{{ $t("definitions.cityId") }} : {{ currentRow.cityId }}</p>
          <p>
            {{ $t("definitions.regionName") }} : {{ currentRow.regionName }}
          </p>
        </q-card-section>
...
export default defineComponent({
  ...
  computed: {
    columns() {
      return [
        {
          name: "city",
          label: this.$t("definitions.city"),
          align: "left",
          field: (row) => row.city.cityName,
          sortable: true,
        },
        {
          name: "regionName",
          label: this.$t("definitions.regionName"),
          align: "left",
  ...
  methods: {
    ...
    onDeleteUser(Regions) {
      this.currentRow = Regions;
    ...
    async userDelete() {
      const response = await this.$api.delete("regions/" + this.currentRow.id);
      this.getList();
